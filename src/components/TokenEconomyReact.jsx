...
const defaultWhyAgents = [
  '→ Gartner: 40% of enterprise apps will have embedded AI agents by end of 2026, up from 5% in Sept 2025³',
  '→ IDC: AI agent use cases grow 10× by 2027',
  '→ Inference now drives 80–90% of all AI compute usage⁵',
  '→ VAST Data declares 2026 "The Year of AI Inference"',
];

const defaultAgenticMarket = [
  { label: 'Agentic AI market 2025', value: '$7.3B²' },
  { label: 'Agentic AI market 2026', value: '$9.1B²' },
  { label: 'Agentic AI market 2034', value: '$139B²' },
  { label: 'CAGR 2026–2034', value: '40.5%²' },
  { label: 'Enterprise AI spend growth', value: '+31.9% p.a. to 2029' },
  { label: 'Total AI investment by 2029', value: '$1.3 trillion' },
];

const defaultAnthropicNumbers = [
  { label: 'Valuation (Feb 2026, Series G)⁶', value: '$380 billion' },
  { label: 'Annualised revenue (Mar 2026)⁸', value: '$19 billion' },
  { label: 'YoY revenue growth⁸', value: '+1,167%' },
  { label: 'Revenue Dec 2024 → Dec 2025⁸', value: '$1B → $9B annualised' },
  { label: '2026 revenue forecast⁷', value: '$18B' },
  { label: 'Business customers⁸', value: '300,000+' },
  { label: 'Enterprise share of revenue⁸', value: '~80%' },
];

const defaultJobsCreated = [
...
const TokenEconomy = ({
  ...
  const marketStatList = marketStats || defaultMarketStats;
  const whyAgentsList = whyAgents || defaultWhyAgents;
  const agenticMarketList = agenticMarket || defaultAgenticMarket;
  const anthropicNumbersList = anthropicNumbers || defaultAnthropicNumbers;
  const jobsCreatedList = jobsCreated || defaultJobsCreated;
  const passiveIncomeList = passiveIncome || defaultPassiveIncome;
  return (
    <motion.section
      id="token-economy"
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="p-5 rounded-xl" style={{ background: 'rgba(0,255,136,0.05)', border: '1px solid rgba(0,255,136,0.2)' }}>
            ...
            <ul className="space-y-3 text-sm">
              {(agenticMarketList || []).map(({ label, value }, i) => (
      ...
      <motion.div variants={itemVariants} className="apple-card mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-3 text-sm">
              {(anthropicNumbersList || []).map(({ label, value }, i) => (
                <li key={i} className="flex justify-between border-b border-slate-800 pb-2">
                  <span style={{ color: 'var(--color-text-secondary)' }}>{label}</span>
